...
import views.html.react.appGroup;
import views.html.react.appPage;
import views.html.react.spaTemplate;
...
public class ReactController extends Controller {
    ...
    public Result index() {
        return ok(spaTemplate.render(views.html.index.render()));
    }
    ...
    public Result appGroup(String groupName) {
        ...
        return ok(spaTemplate.render(appGroup.render(groupName, appsInGroup)));
    }

    public Result appPage(String groupName, String appName) {
        return ok(spaTemplate.render(appPage.render(groupName, appName)));
    }

    public Result buildInfo(String appName, String buildId) {
        return ok(spaTemplate.render(Html.apply("TODO")));
    }
